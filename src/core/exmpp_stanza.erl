...
-spec set_recipient_in_attrs([#xmlattr{}], jidlike() | undefined) ->
  [#xmlattr{}].
...
-spec error(xmlname(), atom(), {lang(), binary() | string() | undefined}) ->
  #xmlel{}.
...
-spec to_list(
    #xmlel{} | #iq{} | #xmlendtag{},
    xmldefaultns(), xmlprefixednss()) -> string().
...
-spec to_binary(
    #xmlel{} | #iq{}| #xmlendtag{},
    xmldefaultns(), xmlprefixednss()) -> binary().
...
-spec to_iolist(
    #xmlel{} | #iq{}| #xmlendtag{},
    xmldefaultns(), xmlprefixednss()) -> iolist().
