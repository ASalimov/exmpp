...
-spec parse(xmlparser(), binary() | string()) ->
...
-spec parse_final(xmlparser(), binary() | string()) ->
...
-spec parse_document_fragment(binary() | string()) ->
  [xmlnode() | xmlendtag()] | continue.
...
-spec attribute(xmlname(), attributename(),
    binary() | string() | atom() | integer()) -> xmlattr().
...
-spec attribute_matches(xmlattr(), xmlname(), xmlname() | attributename()) ->
  boolean().
...
-spec get_attribute_node_from_list([xmlattr()], xmlname(), attributename()) ->
  xmlattr() | undefined.
